if on == 2
{
	...
	if mousetempx == -1000 && mousetempy == -1000
	{
		mousetempx = display_mouse_get_x()
		mousetempy = display_mouse_get_y()	
	}
	mousetempx -= (mousetempx - ((window_get_width()/2) + window_get_x())) * 0.3
	mousetempy -= (mousetempy - ((window_get_height()/2) + window_get_y())) * 0.3
	display_mouse_set(mousetempx, mousetempy)
}
else if on != 2 && on != 1
{
